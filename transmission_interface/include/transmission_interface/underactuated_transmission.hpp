...
#ifndef TRANSMISSION_INTERFACE__UNDERACTUATED_TRANSMISSION_HPP_
#define TRANSMISSION_INTERFACE__UNDERACTUATED_TRANSMISSION_HPP_
 ...
 */
class UnderactuatedTransmission
{
public:
  virtual ~UnderactuatedTransmission() = default;
...
typedef std::shared_ptr<UnderactuatedTransmission> UnderactuatedTransmissionSharedPtr;

}  // namespace transmission_interface

#endif  // TRANSMISSION_INTERFACE__UNDERACTUATED_TRANSMISSION_HPP_
