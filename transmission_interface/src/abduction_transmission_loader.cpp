...
#include "transmission_interface/abduction_transmission_loader.hpp"
...
#include "transmission_interface/abduction_transmission.hpp"

namespace transmission_interface
{
std::shared_ptr<Transmission> AbductionTransmissionLoader::load(
  const hardware_interface::TransmissionInfo & transmission_info)
{
  try
  {
    ...
    std::shared_ptr<Transmission> transmission(new AbductionTransmission(
      {act_reduction1}, {jnt_reduction1, jnt_reduction2},
  ...
  {
    RCLCPP_ERROR(
      rclcpp::get_logger("abduction_transmission_loader"),
...
PLUGINLIB_EXPORT_CLASS(
  transmission_interface::AbductionTransmissionLoader,
